...
type Category struct {
	...
	Id          string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // data type, field name, field number (unique within the message)
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x88, 0x03, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76,
	...
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x62, 0x6c, 0x61, 0x6e,
	0x6b, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22,
	0x00, 0x30, 0x01, 0x12, 0x35, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	0, // 5: pb.CategoryService.ListCategoriesStream:input_type -> pb.blank
	...
	1, // 11: pb.CategoryService.ListCategoriesStream:output_type -> pb.Category
	1, // 12: pb.CategoryService.GetCategory:output_type -> pb.Category
